...
function HeroSection() {
  ...
  return (
    <section className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center mt-10 md:mt-0">
      ...
      <div className="md:w-1/3 flex justify-center items-center relative mt-10 md:mt-0">
        <div className="relative bg-gradient-to-r from-pink-100 to-purple-200 rounded-full p-10 shadow-xl mx-auto">
          <Image
