      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <div className="flex justify-between items-center w-[90%] mx-auto">
          ...
          <div className="flex space-x-4">
            <a href="https://github.com" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaFacebookF />
            </a>
            <a href="www.twitter.com" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaTwitter />
            </a>
